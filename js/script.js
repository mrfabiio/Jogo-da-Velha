...
let buttoons = document.querySelectorAll("#buttons-container button")
...
for(let i = 0; i < buttoons.length; i++) {
    
    buttoons[i].addEventListener("click", function() {
        secondPlayer = this.getAttribute("id")

        for(let j = 0; j < buttoons.length; j++) {
            buttoons[j].style.display = 'none'
        }
